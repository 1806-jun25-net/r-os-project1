...
namespace PizzaPlace.WebApp.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(PizzaPlaceContext context)
        {
            _context = context;
        }
        ...
        //GET: Users/Register
        public async Task<IActionResult> Register(int? id, [Bind("UsersId,FirstName,LastName,LocationId,Phone")] Users users)
        {
            //if (user_id == null)
            //{
            //    return NotFound();
